...
class Card
  def initialize(trivia_data)
    @cards = trivia_data #describe when a new deck is made
  end
​
...
​
deck = Deck.new(trivia_data) # deck is an instance of the Deck class  #calling a new deck of the deck class, holding the trivia data
​
while deck.remaining_cards > 0 #define ammount of cards
  card = deck.draw_card # card is an instance of the Card class  #drawc_card method
  puts card.question  #p question
